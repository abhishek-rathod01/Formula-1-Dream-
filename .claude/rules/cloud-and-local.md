# Working on Formula-1-Dream-: local PC vs cloud session

<!-- Managed by claude-cloud-kit. Edit the kit, re-run generate.py, re-run bootstrap. -->

**Cloud viability: Docs/review only - the real toolchain for this repo does not exist in a cloud session.**
...
- static analysis of F1_Design.py, lint, the mock-API test run, README/CHANGELOG work

## Do NOT attempt this in a cloud session

- anything requiring Fusion 360 -- Windows-only desktop app, adsk.core/adsk.fusion cannot be imported in the cloud
- the pending first in-Fusion confirmation of floor/suspension/diffuser
